...
class TestGenerateDraft:
    ...
    def test_basic_draft_generation(self, mock_llm, mock_research):
        ...
        assert draft["title"] == "AI Revolution 2026"
    ...
    def test_handles_code_block_wrapper(self, mock_llm, mock_research):
        ...
        mock_llm.return_value = '```json\n{"script":"test","broll_prompts":["p1","p2","p3"],"title":"T","description":"D","hashtags":"t","caption":"C","thumbnail_prompt":"P"}\n```'
